...
import com.menusemana.data.db.dao.MealWithIngredients
...
class MealRepositoryImpl
    ...
    constructor(
        ...
        override fun getAllMeals(): Flow<List<Meal>> = mealDao.getAllMealsWithIngredients().map { list -> list.map { it.toDomain() } }

        override suspend fun getMealById(id: Long): Meal? = mealDao.getMealWithIngredientsById(id)?.toDomain()
        ...
        private fun MealWithIngredients.toDomain() =
            Meal(
                id = meal.id,
                name = meal.name,
        ...
        private fun Ingredient.toEntity(mealId: Long) =
            IngredientEntity(
                id = id,
                mealId = mealId,
                name = name,
