...
import com.menusemana.data.util.ErrorType
...
class RecipeRepositoryImpl
    ...
    constructor(
        ...
        override fun getCachedRecipes(): Flow<List<Recipe>> = cacheDao.getAllCached().map { list -> list.map { it.toDomain() } }
        ...
        private fun MealDbItemDto.toRecipe() =
            Recipe(
                mealDbId = id,
                name = name,
                thumbUrl = thumbUrl,
        ...
        private fun RecipeCacheEntity.toDomain() =
            Recipe(
                mealDbId = mealDbId,
                name = name,
                thumbUrl = thumbUrl,
