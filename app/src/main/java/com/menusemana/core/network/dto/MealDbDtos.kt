package com.menusemana.core.network.dto

import com.squareup.moshi.Json
import com.squareup.moshi.JsonClass

@JsonClass(generateAdapter = true)
data class MealDbResponseDto(
    @Json(name = "meals") val meals: List<MealDbItemDto>?,
)
...
data class CategoryDto(
    ...
    @Json(name = "strCategoryThumb") val thumbUrl: String?,
    @Json(name = "strCategoryDescription") val description: String?,
)

@JsonClass(generateAdapter = true)
data class MealDbItemDto(
    ...
    fun getIngredients(): List<Pair<String, String>> {
        ...
        return names.zip(measures)
            ...
            .map { (name, measure) -> name!!.trim() to (measure?.trim() ?: "") }
    }
}
