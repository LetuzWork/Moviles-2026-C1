...
import com.menusemana.data.network.MealDbItemDto
import com.menusemana.data.network.MealDbResponseDto
import com.menusemana.data.network.TheMealDbApi
...
class RecipeRepositoryImplTest {
    ...
    @Test
    fun `search success returns recipes and caches them`() =
        runTest {
    ...
    @Test
    fun `search with null meals list returns empty list`() =
        runTest {
    ...
    @Test
    fun `search network failure returns cached results`() =
        runTest {
    ...
    @Test
    fun `search network failure with empty cache returns Error`() =
        runTest {
            coEvery { api.searchByName("pasta") } throws IOException("no internet")
    ...
    @Test
    fun `getById success returns recipe`() =
        runTest {
    ...
    @Test
    fun `getById network failure returns cached recipe`() =
        runTest {
    ...
    @Test
    fun `getById network failure with no cache returns Error`() =
        runTest {
    ...
    @Test
    fun `getById with empty meals list returns Error`() =
        runTest {
